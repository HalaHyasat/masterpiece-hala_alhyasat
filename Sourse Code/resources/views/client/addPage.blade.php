    ...
    <div style="margin-top: 5rem">
        ...
        <div
            ...
            <div class="text-center py-4 border-b">
                <h3 class="text-lg font-semibold"> Add a New Page </h3>
            ...
            <form action="/pages" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-5">
                    ...
                    <div class="flex-1 pt-2">
                        ...
                        <input name="name" value="{{old('name')}}" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full">
                        @if ($errors->has('name'))
                    ...
                    <div class="flex-1 pt-2">
                        ...
                        <textarea name="desc" class="bg-gray-100 h-12 mt-2 px-3 rounded-md w-full">{{old('desc')}}</textarea>
                        @if ($errors->has('desc'))
                            <div style="color: red">{{ $errors->first('desc') }}</div>
                        @endif
                    </div>
                    ...
                    <div>
                        <button type="submit" name="addPage" class="bg-blue-600 font-semibold p-2 mt-5 rounded-md text-center text-white w-full">
                            Create</button>
                    </div>
                </div>
            </form>
