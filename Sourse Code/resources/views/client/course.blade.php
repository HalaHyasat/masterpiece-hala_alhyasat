                                            ...
                                            <div>
                                                ...
                                                <div class="text-sm flex items-center space-x-3 mt-2">
                                                    ...
                                                    <form action="/home" method="POST">
                                                        ...
                                                        <button type="submit" style="margin-left: 1rem" name="form4" class={{$loved ? "text-red-600" : "text-black-50"}}> <i class="uil-heart"></i> Love </button>
                                                    </form>
            ...
            <div class="lg:w-4/12 flex-shirink-0">
                ...
                <div class="widget border-t pt-6">
                    <div class="flex items-center justify-between mb-2">
                        <div>
                            <h4 class="text-xl -mb-0.5 font-semibold">  Related Courses </h4>
                        </div>
                        <a href="/courses" class="text-blue-600 ">See all</a>
                    </div>
                    <div>
                        @foreach($page->user->pages as $related)
                            @if($related->id != $page->id and $related->id != 0)
                                <a href="{{ route('courses.show', $related->id)}}">
